                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-5">
                                <OwlCarousel
                                    ...
                                    {...options}
                                >
                                    {detailproduct[0]["img"].map((option) => (
                                        <img src={`${backend}${option.url}`} />
                                    ))}
                            ...
                            <div className="col-lg-7">
                                <div className="products-details">
                                    ...
                                    >
                                        <label>Product Harga OTR <span className="required">*</span></label>
                                        ...
                                        <div className="select-box" placeholder="Pilih Harga OTR">
                                            ...
                                            >
                                                ...
                                                {detailproduct[0]["product_otrs"].map((option) => (
                                        ...
                                        <div className="select-box" placeholder="Pilih Harga OTR">
                                            ...
                                            >
                                                ...
                                                {detailproduct[0]["product_image_colors"].map((option) => (
